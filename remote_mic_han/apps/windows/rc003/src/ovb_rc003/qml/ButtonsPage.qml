    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Label {
                ...
                wrapMode: Text.WordWrap
                horizontalAlignment: Text.AlignHCenter
                text: qsTr("点击实物按键定位映射；普通键可直接输入任意组合键，麦克风键的语音组合键也可编辑。Windows 可能不会上送返回键和音量键；只有“检测真实按键”显示完整按下/松开后，该物理键才可用于映射。遥控器没有独立静音键。")
        ...
        ColumnLayout {
            ...
            GridView {
                ...
                property bool initialPositioningComplete: false
