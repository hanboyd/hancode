...
> 本节面向安装和使用 1.0.1 的用户；后面的技术说明用于开发者和维护者。
> 1.0.1 已完成真实 RC003 的 BLE/ATVV 与 Typeless 语音链路验收；
