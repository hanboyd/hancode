...
> The home of RemoteMic Windows, an actively developed Windows remote-microphone project.
...
`hancode` is the development repository for **RemoteMic Windows**: a Windows client that connects a Xiaomi Bluetooth Remote 2 Pro (RC003) to voice-input applications.
...
- `remote_mic_han` is the maintained project and the place to begin.
