...
- Status: superseded
- Date: 2026-08-23
- Superseded by: ADR-0006. The revert commit `287db60` was based on an
  incorrect hold-to-dictate interpretation. The user later confirmed that
  both current host tools use one short tap to open and a later short tap to
  close; ADR-0006 records the target-independent RemoteMic protocol.
